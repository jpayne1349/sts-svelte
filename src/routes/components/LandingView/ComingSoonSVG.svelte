<div class="construction-container">
	...
	C890.9,218.3,889.8,219.4,888.4,219.4z"
			...
			<g>
				...
				/>
				<path
					d="M363.5,238.1v28.8H358V248l-2.8,18.9H353l-3.1-19v19h-5.5v-28.8h7.4l2.1,14.5l1.9-14.5H363.5z"
				/>
		...
		<p class="construction-message">Projects for display are under construction!</p>
	</div>
</div>
