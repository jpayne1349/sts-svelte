...
<div id="pricing-container">
	...
	<div id="right-section" bind:this={right_section} class:show={right_class}>
		...
		<div class="details">
			Every project is different and most quotes will reflect that. We break down costs into build fees and monthly fees.
			Anything web related requires monthly fees that either you can manage, or you can pay us to manage.
			Simple static websites and landing pages average a $200-$500 build
