...
<div data-custom-class="body" id="wrapper">
		...
		<span style="color: rgb(127, 127, 127);"
			><span style="color: rgb(89, 89, 89); font-size: 1.5vw;"
				><span data-custom-class="body_text"
					...
					cookies and similar technologies to recognize you when you visit our websites at<bdt
						class="forloop-component"
					/> <bdt class="question">https://www.southtexas.software</bdt>,
					<bdt class="question">https://southtexas.software</bdt>,
					<bdt class="question">https://www.southtexassoftware.com</bdt>,
					<bdt class="question">https://southtexassoftware.com</bdt>,<bdt
						class="forloop-component"
					/>
					("<strong>Websites</strong>"). It explains what these technologies are and why we use
					them, as well as your rights to control our use of them.<bdt
		...
		<span style="color: rgb(127, 127, 127);"
			><span style="color: rgb(89, 89, 89); font-size: 15px;"
				><span data-custom-class="body_text"
					...
					personal information if we combine it with other information. <bdt
						class="block-component"
					/></span
				><bdt class="statement-end-if-in-editor"><span data-custom-class="body_text" /></bdt></span
			></span
		>
	</div>
	<div style="line-height: 1.5;"><br /></div>
		...
		<span style="color: rgb(127, 127, 127);"
			><span style="color: rgb(89, 89, 89); font-size: 15px;"
				><span data-custom-class="body_text"
					...
					work, or to work more efficiently, as well as to provide reporting information.</span
				></span
			></span
		>
	</div>
	...
	<div style="line-height: 1.5;">
		<span style="color: rgb(127, 127, 127);"
			><span style="color: rgb(89, 89, 89); font-size: 15px;"
				><span data-custom-class="body_text"
					>Cookies set by the website owner or <bdt class="question"><strong>Company</strong></bdt>
					...
					be provided on or through the website (e.g. like advertising, interactive content and analytics).
					The parties that set these third party cookies can recognize your computer both when it visits
					the website in question and also when it visits certain other websites.</span
				></span
			></span
		>
	</div>
		...
		<span style="color: rgb(127, 127, 127);"
			><span style="color: rgb(89, 89, 89); font-size: 15px;"
				><span data-custom-class="body_text"
					...
					for our Websites to operate, and we refer to these as "essential" or "strictly necessary" cookies.
					...
					<bdt class="block-component" />Third parties serve cookies through our Websites for
					advertising, analytics and other purposes. <bdt class="statement-end-if-in-editor" />This
					is described in more detail below.</span
				></span
			></span
		>
	</div>
	...
	<div style="line-height: 1.5;">
		<span style="color: rgb(127, 127, 127);"
			><span style="color: rgb(89, 89, 89); font-size: 15px;"
				><span data-custom-class="body_text"
					>The specific types of first<bdt class="block-component" /> and third<bdt
						class="statement-end-if-in-editor"
				...
				><span style="font-size: 15px; color: rgb(89, 89, 89);"
					><span style="font-size: 15px; color: rgb(89, 89, 89);"
						><span id="control" style="color: rgb(0, 0, 0);"
							><strong><span data-custom-class="heading_1">How can I control cookies?</span></strong
							></span
						></span
					></span
				></span
	...
	<div style="line-height: 1.5;">
		<span style="font-size: 15px; color: rgb(89, 89, 89);"
			...
			><span style="font-size: 15px; color: rgb(48, 48, 241);"
				><span data-custom-class="body_text"
				...
				></span
			><span style="font-size: 15px; color: rgb(89, 89, 89);"
				><span data-custom-class="body_text"> or </span></span
			><span style="font-size: 15px; color: rgb(48, 48, 241);"
				><span data-custom-class="body_text"
					><a
	...
	<div style="line-height: 1.5;">
		...
		><span style="font-size: 15px;" /><span
			...
			><span style="font-size: 15px;"
				><strong><u><br /><br />Essential website cookies:</u></strong></span
			></span
		>
	</div>
	<div>
			...
			<span style="color: rgb(127, 127, 127);"
				><span style="color: rgb(89, 89, 89); font-size: 15px;"
					><span data-custom-class="body_text"
						...
						Websites and to use some of its features, such as access to secure areas.</span
					></span
				></span
			>
		</div>
			...
			><span style="color: rgb(89, 89, 89); font-size: 15px;"
				><span data-custom-class="body_text">Cookies are not the only way </span><span
					...
					><span data-custom-class="body_text"
						...
						gifs"). These are tiny graphics files that contain a unique identifier that enable us to
						recognize when someone has visited our Websites<bdt class="block-component" /> or opened
						an e-mail including them<bdt class="statement-end-if-in-editor" />. This allows us, for
						example, to monitor
						...
						><span style="color: rgb(89, 89, 89);"
							><span data-custom-class="body_text"
								...
								declining cookies will impair their functioning.</span
	...
	<div style="line-height: 1.5;">
		...
		><span style="font-size: 15px; color: rgb(89, 89, 89);"
			><span data-custom-class="body_text"> and </span><span
				style="font-size:15px; color: rgb(89, 89, 89);"
				><span data-custom-class="body_text"
					>following the instructions (which may include instructions that explain, for example, how
					to delete existing Flash Cookies (referred to "information" on the Macromedia site), how
					to prevent Flash LSOs from being placed on your computer without your being asked, and
	...
	<div style="line-height: 1.5;">
		...
		><span style="color: rgb(127, 127, 127);"
			><span style="color: rgb(89, 89, 89); font-size: 15px;"
				><span style="font-size: 15px; color: rgb(89, 89, 89);"
					><span style="font-size: 15px; color: rgb(89, 89, 89);"
						><span style="color: rgb(89, 89, 89);"><bdt class="statement-end-if-in-editor" /></span
						></span
					></span
				></span
			></span
	...
	<div style="line-height: 1.5;">
		<span style="font-size: 15px; color: rgb(89, 89, 89);"
			><span style="font-size: 15px; color: rgb(89, 89, 89);"
				><span style="font-size: 15px; color: rgb(0, 0, 0);"
					><strong
						><span data-custom-class="heading_1">Where can I get further information?</span></strong
					></span
				></span
			></span
		>
			...
			><span style="font-size: 15px; color: rgb(89, 89, 89);"
				><span style="font-size: 15px; color: rgb(89, 89, 89);"
					><span data-custom-class="body_text"
						...
						us at <bdt class="question"><strong><a href='mailto:info@southtexas.software'>info@southtexas.software</a></strong></bdt></span
					></span
				></span
			></span
		>
