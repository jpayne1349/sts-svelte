<script>
	...
	import ActionNeededBar from './ActionNeededBar.svelte';
...
<nav class="portal-navbar">
	<a href="/client/portal/overview" class:active={$page.url.pathname == '/client/portal/overview'}>Overview</a>
	<a href="/client/portal/profile" class:active={$page.url.pathname == '/client/portal/profile'}>Profile</a>
	<a href="/client/portal/billing" class:active={$page.url.pathname == '/client/portal/billing'}>Billing</a>
	<a href="/client/portal/development" class:active={$page.url.pathname == '/client/portal/development'}
		>Development</a
	>
</nav>

{#each $sessionStore.billing.open_documents as doc}
	<ActionNeededBar doc={doc} />
{/each}
