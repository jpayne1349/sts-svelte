...
<section class="container" id="sign-in-container">
	...
	<form method="POST" id="sign-in-form" on:submit|preventDefault={signInAttempt} bind:this={form_element}>
		...
		<input name="password" id="password-input" class="input" type="password" required autocomplete='current-password' />
