<script>
	...
	async function setupSubscription() {
		...
		let status_message = 'Pending Review';
		if ($sessionStore.subscription.status != '') {
			status_message = $sessionStore.subscription.status + ' - Change Requested';
		}
...
<div class="service-wrapper">
	<section class="container" id="subscription_service">
		...
		<p>
			Please select your current service agreement, or the services you are interested in receiving.
